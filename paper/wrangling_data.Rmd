...
title: |
  | Wrangling Pre-harmonized Data: 
  | Best Practices Based on Harmonizing Income Inequality and 
  | Aggregate Public Opinion Measures
thanks: "Corresponding author: [frederick-solt@uiowa.edu](mailto:frederick-solt@uiowa.edu). Current version: `r format(Sys.time(), '%B %d, %Y')`.  Replication materials and complete revision history may be found at [https://github.com/fsolt/wrangling_data](https://github.com/fsolt/wrangling_data)."
author:
- Yue Hu
...
bibliography: wrangling-data.bib

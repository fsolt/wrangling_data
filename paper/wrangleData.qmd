...
The routine includes three steps: data selection, entry, and opening.
...
1. automate data entry; and 
1. "second-order" data opening.
...
## Step 2: Automate Data Entry {#sec-automate}
...
For the remaining `r 100 - automated_percent`% of the SWIID observations, for instance, we collected them using Sepulveda's [-@Sepulveda2024] `tabulapdf` R package to avoid data-entry errors as long as they are in pdf.

...
In short, incomplete or inaccurate data entry, the absence of reproducibility, and trackless human discretion in manual janitor work have collectively become major obstacles on the way to data harmonization, yet these challenge has received surprisingly little attention.
...
The dual-entry process allows for automated cross-checks of the newly entered data that increase the chances of identifing and correcting errors [see @BarchardPace2011].

...
In @sec-packages, we also provide an incomplete list of R packages that can ease the processes to, for example, collect data with APIs and clean and transform data. 
Readers can also use the codes in this article's replication file to explore more automation options for more specific needs.

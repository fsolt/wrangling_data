...
Our three recommendations---to maximize automization, use the double-entry method, and embrace teamwork---unquestionably take effort [cf., @EngzellRohrer2021].
...
Moreover, as the example of `DCPOtools` demonstrates, many common janitor-work chores already have been packaged as open-source software to make researchers' task even easier and more straightforward. 
...
# Data-Entry Problems in the Democratic Support Source Data
Comparing the original hand-entered dataset [@Claassen2020c] with data that were machine-collected using the `DCPOtools` package for R [@Solt2018] revealed three survey items for which the hand-entered data did not match the data's documented coding rules.

...
To avoid potential data-entry errors (as well as to ensure that the updates and revisions that are frequent in many of these sources are automatically incorporated as they become available), the process of collecting these source data is automated to the greatest extent practicable.^[

...
The conventional approach usually involves a notorious bulk of manual work, such as indicator identification, data merging, and data scaling [see, e.g., @Lohr2014].
This tiresome process is prone to introducing errors during data collection. 
